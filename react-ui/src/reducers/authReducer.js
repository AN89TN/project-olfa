import {
  ...
  const initialState = {
    ...
    userLoginLoading: false, // to indicate that the user login API is in progress
    loginError: null, // manage the error of the user login API
